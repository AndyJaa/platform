...
export default {
    mounted() {
        this.$notify({
            ...
            message: `
                <p>当前访问的是<b>易捷招商品平台</b></p>
                <p>你可以点<a href="" target="_blank"><b>这里</b></a>访问专业版</p>
            `,
