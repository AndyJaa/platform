    ...
    <div class="user">
        ...
        <el-dropdown class="user-container" @command="handleCommand">
            ...
            <el-dropdown-menu slot="dropdown" class="user-dropdown">
                <el-dropdown-item style="font-size: 0.24rem;" v-if="$store.state.settings.enableDashboard" command="dashboard">控制台</el-dropdown-item>
                <el-dropdown-item style="font-size: 0.24rem;" command="setting">个人设置</el-dropdown-item>
                <el-dropdown-item style="font-size: 0.24rem;" divided command="logout">退出登录</el-dropdown-item>
            </el-dropdown-menu>
        </el-dropdown>
    </div>
</template>
